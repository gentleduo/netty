...
public final class GameMsgProtocol {
    ...
    /**
     * <pre>
     * 消息代号（客户端到服务器的消息都是以CMD结尾，服务器回复给客户端的消息都是以RESULT结尾）
     * </pre>
     * <p>
    ...
    public static final class UserEntryCmd extends
        ...
        public static final class Builder extends
            ...
            // Construct using org.duo.herostory.msg.GameMsgProtocol.UserEntryCmd.newBuilder()
            private Builder() {
    ...
    public static final class UserEntryResult extends
        ...
        public static final class Builder extends
            ...
            // Construct using org.duo.herostory.msg.GameMsgProtocol.UserEntryResult.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public static final class WhoElseIsHereCmd extends
        ...
        public static final class Builder extends
            ...
            // Construct using org.duo.herostory.msg.GameMsgProtocol.WhoElseIsHereCmd.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public static final class WhoElseIsHereResult extends
        ...
        public static final class UserInfo extends
            ...
            public static final class MoveState extends
                ...
                public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
                    if (Float.floatToRawIntBits(fromPosX_) != 0) {
                        output.writeFloat(1, fromPosX_);
                    }
                    if (Float.floatToRawIntBits(fromPosY_) != 0) {
                        output.writeFloat(2, fromPosY_);
                    }
                    if (Float.floatToRawIntBits(toPosX_) != 0) {
                        output.writeFloat(3, toPosX_);
                    }
                    if (Float.floatToRawIntBits(toPosY_) != 0) {
                ...
                public static final class Builder extends
                    ...
                    // Construct using org.duo.herostory.msg.GameMsgProtocol.WhoElseIsHereResult.UserInfo.MoveState.newBuilder()
                    private Builder() {
                        maybeForceBuilderInitialization();
                    }
            ...
            public static final class Builder extends
                ...
                // Construct using org.duo.herostory.msg.GameMsgProtocol.WhoElseIsHereResult.UserInfo.newBuilder()
                private Builder() {
                    maybeForceBuilderInitialization();
                }
        ...
        public static final class Builder extends
            ...
            // Construct using org.duo.herostory.msg.GameMsgProtocol.WhoElseIsHereResult.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public static final class UserMoveToCmd extends
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output)
                throws java.io.IOException {
            if (Float.floatToRawIntBits(moveFromPosX_) != 0) {
                output.writeFloat(1, moveFromPosX_);
            }
            if (Float.floatToRawIntBits(moveFromPosY_) != 0) {
                output.writeFloat(2, moveFromPosY_);
            }
            if (Float.floatToRawIntBits(moveToPosX_) != 0) {
                output.writeFloat(3, moveToPosX_);
            }
            if (Float.floatToRawIntBits(moveToPosY_) != 0) {
        ...
        public static final class Builder extends
            ...
            // Construct using org.duo.herostory.msg.GameMsgProtocol.UserMoveToCmd.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public static final class UserMoveToResult extends
        ...
        public static final class Builder extends
            ...
            // Construct using org.duo.herostory.msg.GameMsgProtocol.UserMoveToResult.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public static final class UserQuitResult extends
        ...
        public static final class Builder extends
            ...
            // Construct using org.duo.herostory.msg.GameMsgProtocol.UserQuitResult.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public static final class UserStopCmd extends
        ...
        public static final class Builder extends
            ...
            // Construct using org.duo.herostory.msg.GameMsgProtocol.UserStopCmd.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public static final class UserStopResult extends
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output)
            ...
            if (Float.floatToRawIntBits(stopAtPosX_) != 0) {
                output.writeFloat(2, stopAtPosX_);
            }
            if (Float.floatToRawIntBits(stopAtPosY_) != 0) {
        ...
        public static final class Builder extends
            ...
            // Construct using org.duo.herostory.msg.GameMsgProtocol.UserStopResult.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public static final class UserAttkCmd extends
        ...
        public static final class Builder extends
            ...
            // Construct using org.duo.herostory.msg.GameMsgProtocol.UserAttkCmd.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public static final class UserAttkResult extends
        ...
        public static final class Builder extends
            ...
            // Construct using org.duo.herostory.msg.GameMsgProtocol.UserAttkResult.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public static final class UserSubtractHpResult extends
        ...
        public static final class Builder extends
            ...
            // Construct using org.duo.herostory.msg.GameMsgProtocol.UserSubtractHpResult.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
    ...
    public static final class UserDieResult extends
        ...
        public static final class Builder extends
            ...
            // Construct using org.duo.herostory.msg.GameMsgProtocol.UserDieResult.newBuilder()
            private Builder() {
                maybeForceBuilderInitialization();
            }
